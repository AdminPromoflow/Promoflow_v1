...
/*  Created On : 23-Aug-2025 5:42:39 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT `PK_Supplier` PRIMARY KEY (`idSupplier` ASC)
)
...
ALTER TABLE `Jobs` 
 ADD CONSTRAINT `FK_Jobs_Supplier`
	FOREIGN KEY (`idSupplier`) REFERENCES `Supplier` (`idSupplier`) ON DELETE Restrict ON UPDATE Restrict
;
