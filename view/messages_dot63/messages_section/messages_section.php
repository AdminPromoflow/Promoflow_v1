<?php
$cssPath = '../../view/messages_dot63/messages_section/messages_section.css';
$jsPath  = '../../view/messages_dot63/messages_section/messages_section.js';
...
<section class="msg-shell">
  ...
  <main class="msg-main">
    ...
    <section class="msg-reader" aria-label="Selected message">
      ...
      <form class="msg-inputbar" id="msg-form-dot63" autocomplete="off">
        <input
          id="msg-input-dot63-main"
          class="msg-input"
          type="text"
          placeholder="Write a message…"
        >
        <button id="send_dot63_main" class="msg-btn msg-btn-primary" type="submit">
          Send
        </button>
      </form>
    </section>
...
<div class="msg-modal" hidden>
  <div class="msg-modal-card" role="dialog" aria-modal="true" aria-labelledby="msg-modal-title">
    ...
    <div class="msg-modal-body">
      ...
      <label class="msg-field">
        <span>Message</span>
        <textarea id="msg-input-dot63-modal" rows="7" placeholder="Write your message…"></textarea>
      </label>
    </div>

    <div class="msg-modal-footer">
      <button id="send_dot63_modal" class="msg-btn msg-btn-primary" type="button">
        Send
      </button>
    </div>
  </div>
